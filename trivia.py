...
- 대화 중 핵심 단어·중요한 수치·핵심 문장에는 **굵게** 표시. 예: **99%가 모름**, **3배 더 빠름**
- 출력 형식 (반드시 이 대로):
[CHAT]
{BLOG_NAME}: (설명하는 말)
독자: (짧은 반응이나 질문)
...
[형식 조건]
- 분량: 600~800단어 (한국어 약 2400~3200자). 800단어를 절대 넘지 않는다. 억지 패딩 금지.
...
- 문체: 독자에게 친근하게 말하는 경어체로 쓴다. 본문 문장 종결은 반드시 ~습니다/~입니다/~합니다.
  ...
  ❌ 딱딱한 기사체·교과서체 금지: "~것으로 알려졌다", "~연구에 의하면" 같은 표현 최소화.
  ✅ "솔직히", "이게 진짜 신기한 부분인데요", "쉽게 말하면", "한마디로" 같은 표현 적극 활용.
...
④ 마무리 문단이 글 전체 주제를 자연스럽게 정리하는가, 아니면 뜬금없는 내용으로 끝나는가?
