...
THEMES = [
    ...
    },
    {
        ...
        'ideas': [
            ...
            '[장 건강이 피부·기분까지 바꾸는 이유 — 프로바이오틱스 제대로 먹는 법]',
            '[카페인 의존도 셀프 진단 — 커피 끊으면 몸에 실제로 일어나는 일]',
            '[공복 혈당 스파이크가 살찌는 진짜 이유 — 아침 식사 순서 바꾸기]',
        ],
        'practical_keyword': '오늘부터 바꾸는 건강 습관, 식단 조절법, 수면·영양 실천 가이드',
    },
    {
        'name': '운동',
        'ideas': [
            ...
            '[헬스장 안 가도 되는 홈트 루틴 — 맨몸 운동 4주 플랜]',
            '[살 빠지지 않는 운동의 공통점 — 운동 강도보다 중요한 것]',
            '[무릎 아프지 않게 달리는 법 — 착지 자세부터 신발 선택까지]',
        ],
        'practical_keyword': '오늘부터 바로 실천하는 운동 루틴, 주간 플랜, 단계별 가이드',
    },
]
