...
- 문체: 친구한테 설명하듯 쉽고 편하게. 단, 본문 문장 종결은 반드시 ~다/~이다/~한다.
  ...
  ✅ "이게 왜 중요하냐면", "쉽게 말하면", "한마디로", "솔직히" 같은 표현 적극 활용.
  ❌ ~습니다/~요 금지.
...
- 문체: 친구한테 설명하듯 쉽고 편하게. 반드시 평어체 ~다/~이다.
  ❌ ~습니다/~요/~죠 금지. ❌ 교과서·기사체 금지.
  ✅ "솔직히", "이게 진짜 신기한 게", "쉽게 말하면", "한마디로" 적극 활용.
...
- 전문용어 첫 등장 시 괄호로 쉬운 설명.
- 문체: 친구한테 설명하듯 쉽고 편하게. ~다/~이다.
  ❌ 교과서·기사체 금지. ✅ "솔직히", "쉽게 말하면", "이게 진짜 신기한 게" 적극 활용.
